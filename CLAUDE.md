...
MC Tools is a WordPress plugin providing a collection of Gutenberg blocks for Minecraft-related websites.

**PHP 8.1+ minimum.** Strict types everywhere (`declare(strict_types=1)`).

## Architecture

- Entry point: `plugin.php` → `src/Plugin.php`
- PSR-4 autoloading: `Apermo\McTools\` → `src/`
